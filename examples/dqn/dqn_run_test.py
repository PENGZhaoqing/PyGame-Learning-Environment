...
def main():
    ...
    parser.add_argument('-m', '--model_prefix', required=False, type=str, default='QNet',
                        help='Prefix of the saved model file.')
    parser.add_argument('-t', '--test-steps', required=False, type=int, default=12500,
                        help='Test steps.')
    ...
    args.dir_path = "dqn-breakout-lr0.01"
    args.model_prefix = "QNet"
    # args.visualization = "0"
    args.epoch_range = "24,26"
